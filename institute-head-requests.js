(() => {
 ...
 let records = [], notifications = [], selected = null, busy = false, loading = false, detailToken = 0;
 ...
 async function decide(e) {
  ...
  try{await rpc('decide_institute_head_request',{p_request_id:id,p_decision:decision,p_remark:remark||null});selected=await rpc('get_institute_head_request',{p_request_id:id});showDetail();await refresh();}
